...
# Load data
df_r <- read_csv(
  here::here("world_record_progression/ratio.csv")
  )
dat <- read_csv(
  here::here("world_record_progression/world_record_progression_data_desc.csv"),
...
anim_save(here::here("world_record_progression/p100.gif"), p100)
```
...
anim_save(here::here("world_record_progression/p400.gif"), p400)
```
...
anim_save(here::here("world_record_progression/p1500.gif"), p1500)
```
...
anim_save(here::here("world_record_progression/p5000.gif"), p5000)
```
...
anim_save(here::here("world_record_progression/p10000.gif"), p10000)
```
...
anim_save(here::here("world_record_progression/pmara.gif"), pmara)
```
